...
#sharlatex {#start}
#*** sharlatex and overleaf, sync with Github (vim) ---
##https://www.overleaf.com/project/5d1f4419460443357489e46f
#Overleaf:
...
abstract: {#abstract}
Head and neck squamous cell carcinoma (HNSCC) represents a major health concern worldwide. It is a conventional way to mine the gene expression–based prognostic markers by survival analysis of clinicopathologic datasets from the Cancer Genome Atlas (TCGA). Gene expression data are usually represented by metric variables. In order to utilize a continuous variable for survival analysis, it is necessary to determine a cutoff point in terms of dichotomizing patients for biomarker discovery. There are several optimization and visualization software for cutoff determination, such as Prognoscan, Cutoff Finder, Findcut, and Human protein atlas. However, they only pick up median, 1/4 quarter, 3/4 quarter of RNA sequencing (RNA-seq) to find the significant P-value of Kaplan–Meier method. In advance, there is few clinicopathologic features available on their websites.
We developed a comprehensive workflow by R script on Rstudio server. It includes data process, feature selection, cutoff mining engine, survival analysis as well as Cox porportional hazard analysis. According the tables and ranking of hazard ratio, we suggested those genes may be potential therapeutic targets for treating HNSCC patients.
...
Those differentially expressed proteins in HNSCC was never reported in previous articles.
Taking all together, through global genome scanning we elucidated that OOO might be  new candidates for HNSCC therapy.


# Material and method
<!-- # since the date [2019/05/13] after -->
*** [template of my manuscript] 範例
0) https://journals.sagepub.com/doi/epub/10.1177/1533033818767455 Identification of Significant Gene Signatures and Prognostic Biomarkers for Patients With Cervical Cancer by Integrated Bioinformatic Methods (Rstudio, TCGA, edgeR)
...
#TANRIC database: https://www.tanric.org; The Atlas of Noncoding RNAs in Cancer (TANRIC) database
https://ibl.mdanderson.org/tanric/_design/basic/download.html; The Atlas of Noncoding RNAs in Cancer: It characterizes the expression profiles of lncRNAs in large patient cohorts of 20 cancer types including TCGA, CCLE and other independent datasets. (Reference: http://cancerres.aacrjournals.org/content/75/18/3728)
...
#*** [重要討論] 
***(multiple testing 是發生在 cutoff_finder.R 100切)
0) cutoff finding #***
Tex: cut by 人頭[30...70]
Dato 你的方法跟..之間有和差異嗎? {\todo}
***還有很多方法: https://github.com/RRafiee/Omics
...
=======
Text S1\cite{Budczies2012}.
R code of the functions that are used for cutoff optimization and the generation of plots.
>>>>>>> 12a81c226f6c3eb1b42ffd4d5633117c4fbcda3c
