...
run mainA (marginS)
call function(survival_marginS) on TCGA_HNSCC_marginS.R, 122 rename LUAD.mRNA.Exp., 139 load(file="LUAD_T522_clinical_fullFeatures11_dichotomized.Rda")
...
7)[COXPH modelling] with OS, RFS; ; HNSCC features: pathologic to clinical TNM
rename LUAD.mRNA.Exp.
export to .Rda and .XLS (appending is better)
