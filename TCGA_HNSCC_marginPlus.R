...
survival_marginPlus <- function(geneName) { 
...
# 6) call cutofFinder_func_HNSCC.R, run100; source defined on main ####
  marginTag <- "_marginPlus_" # with margin 0 alone
  #browser()
...
filenamex <- paste("xlsx/", TCGA_cohort, "_survivalAnalysis_marginPlus_", geneName, ".xlsx", sep = "")
...
#tryCatch(
  ...
  save(list = c("tableChi1", "tableOS1", "tableRFS1", "OS_pvalue", "RFS_pvalue"), file=paste("xlsx/HNSCC_survivalAnalysis_marginPlus_", geneName, ".Rda", sep=""))
